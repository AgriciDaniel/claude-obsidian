...
- **cli** — `obsidian-cli read vault="$VAULT_NAME" path="$NOTE"` and `obsidian-cli search vault="$VAULT_NAME" query="<query>"` (Obsidian-native ranking); see [`skills/wiki-cli/SKILL.md`](../wiki-cli/SKILL.md)
