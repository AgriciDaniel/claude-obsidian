...
- Prioritised speed moat first, then data moat, then workflow moat.
...
- Use the report's agent task cards to start Phase 2: real ingestion, scoring evidence, alerts, and outcome learning.
